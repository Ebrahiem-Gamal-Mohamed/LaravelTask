...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h2 class="h2 text-center">Edit {{ $employee->first_name }} {{ $employee->last_name }}</h2>
                    <form class="custom_form" action="{{ url('employee/update') }}" method="POST" enctype="multipart/form-data" >
                        @csrf
